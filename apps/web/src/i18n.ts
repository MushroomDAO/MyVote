...
export const messages: Record<AppLocale, Record<string, string>> = {
  'zh-CN': {
    ...
    voteChoice: '选择选项',
    voteSubmitted: '投票已提交',
    sxAlreadyVoted: '你已在此提案上投过链上票，链上投票不可重复或更改。',
    sxViewTx: '查看交易',
    sxVotePower: '投票权重',
    sxYourChoice: '你投的是',
    offchainAlreadyVoted: '你已在此提案上投过票，可重新投票以更改选择。',
    voteError: '投票失败',
    ...
    errSxVoteClosed: '该链上提案的投票已结束',
    errSxVoteNotStarted: '该链上提案的投票尚未开始',
    errSxNoAuthenticator: '该链上空间没有可用的签名验证器（authenticator）',
    ...
    emailCodeSent: '验证码已发送，请查收邮件（也看看垃圾箱）',
    emailCodeRequired: '请输入邮件里的验证码',
    emailCodeInvalid: '验证码不正确或已过期',
    emailCodeUnavailable: '本环境未开启邮箱验证，可直接注册',
  ...
  en: {
    ...
    sxAlreadyVoted: 'You have already voted on-chain; an on-chain vote cannot be repeated or changed.',
    sxViewTx: 'View transaction',
    sxVotePower: 'Voting power',
    sxYourChoice: 'Your choice',
    offchainAlreadyVoted: 'You already voted on this proposal; vote again to change it.',
    ...
    errSxVoteClosed: 'Voting on this on-chain proposal has closed',
    errSxVoteNotStarted: 'Voting on this on-chain proposal has not started yet',
    errSxNoAuthenticator: 'This on-chain space has no usable signature authenticator',
    ...
    spaces: 'Spaces',
    empty: 'No data',
    emptyFiltered: 'No proposals in this state',
    loadMore: 'Load more',
    results: 'Results',
    votes: 'votes',
    register: 'Register',
    ...
    emailCodeSent: 'Code sent — check your inbox (and spam)',
    emailCodeRequired: 'Enter the code from the email',
    emailCodeInvalid: 'Code is wrong or has expired',
    emailCodeUnavailable: 'Email verification is off here — register directly',
    emailCodeSendFailed: 'Could not send the code, try again later',
